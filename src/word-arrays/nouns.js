...
export const NOUNS = [
    ...
    new Noun('арбуз', 'die', 'Wassermelone', 'Wassermelonen'),
    new Noun('виноград', 'die', 'Traube', 'Trauben'),
    new Noun('дыня', 'die', 'Honigmelone', 'Honigmelonen'),
    ...
    new Noun('знаменитость', 'die der', 'Promi', 'Promis'),
    ...
    new Noun('общежитие, совместное проживание', 'die', 'Wohngemeinschaft', 'Wohngemeinschaften'),
    ...
    new Noun('гроза', 'das', 'Gewitter', 'Gewitter'),
    new Noun('настроение', 'die', 'Laune', 'Launen'),
    new Noun('ураган, шторм', 'der', 'Sturm', 'Stürme'),
    new Noun('крыша, чердак', 'das', 'Dach', 'Dächer'),
    new Noun('сторона света', 'die', 'Himmelsrichtung', 'Himmelsrichtungen'),
    new Noun('счастье, удача', 'das', 'Glück', null, true),
    new Noun('новоселье', 'die', 'Einweihungsparty', 'Einweihungspartys'),
    new Noun('Рождество Христово', 'das', 'Weihnachten', 'Weihnachten'),
    new Noun('пасха', 'das', 'Ostern', 'Ostern'),
    new Noun('новогодний вечер', 'das', 'Silvester', 'Silvester'),
    new Noun('новый год', 'das', 'Neujahr', 'Neujahre'),
    ...
    new Noun('собственность', 'das', 'Eigentum', null, true),
    new Noun('родной дом', 'das', 'Heim', 'Heime'),
    new Noun('место', 'die', 'Lage', 'Lagen'),
    ...
    new Noun('пересадка (самолет), отключение', 'der', 'Anschluss', 'Anschlüsse'),
    ...
    new Noun('обслуживание, условие', 'die', 'Bedienung', 'Bedienungen'),
    new Noun('качество (высокое)', 'die', 'Qualität', null, true),
    new Noun('издательство', 'der', 'Verlag', 'Verlage'),
    new Noun('реклама (распространенно)', 'die', 'Werbung', null, true),
    new Noun('объявление', 'die', 'Ansage', 'Ansagen'),
    new Noun('телефонная связь', 'die', 'Durchwahl', null, true),
    ...
    new Noun('средство передвижения', 'der', 'Verkehr', null, true),
    new Noun('транспорт', 'der', 'Transport', 'Transporte'),
    new Noun('предположение', 'die', 'Vermutung', 'Vermutungen'),
    new Noun('убеждение', 'die', 'Überzeugung', 'Überzeugungen'),
