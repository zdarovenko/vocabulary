...
export const VERBS = [
    ...
    new Verb('просыпаться', 'aufstehen', 'steht auf', 'stand auf', 'hat aufgestanden'),
    ...
    new Verb('мерзнуть', 'fieren', 'friert', 'fror', 'hat gefroren'),
    ...
    new Verb('тонуть', 'ertrinken', 'ertrinkt', 'ertrank', 'ist ertrunken'),
    new Verb('тонуть', 'ertrinken', 'ertrinkt', 'ertrank', 'ist ertrunken'),
    new Verb('тонуть', d'ertrinken', 'ertrinkt', 'ertrank', 'ist ertrunken'),
